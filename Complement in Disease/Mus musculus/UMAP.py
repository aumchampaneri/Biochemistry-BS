...
umap_gene_expression(adata, f"{disease}", "Cfh", "C3", gene_dict, save_path="Mm-Normal_umap_CFHvC3.pdf")

# Plot UMAP of CFH and C3ar1 expression
umap_gene_expression(adata, f"{disease}", "Cfh", "C3ar1", gene_dict, save_path="Mm-Normal_umap_CFHvC3ar1.pdf")

# Plot UMAP of CFH and C5ar1 expression
umap_gene_expression(adata, f"{disease}", "Cfh", "C5ar1", gene_dict, save_path="Mm-Normal_umap_CFHvC5ar1.pdf")

# Plot UMAP of CFH and C5ar2 expression
umap_gene_expression(adata, f"{disease}", "Cfh", "C5ar2", gene_dict, save_path="Mm-Normal_umap_CFHvC5ar2.pdf")

# Plot UMAP of C3ar1 and C5ar1 expression
umap_gene_expression(adata, f"{disease}", "C3ar1", "C5ar1", gene_dict, save_path="Mm-Normal_umap_C3ar1vC5ar1.pdf")

# Plot UMAP of C3ar1 and C5ar2 expression
umap_gene_expression(adata, f"{disease}", "C3ar1", "C5ar2", gene_dict, save_path="Mm-Normal_umap_C3ar1vC5ar2.pdf")

# Plot UMAP of C5ar1 and C5ar2 expression
umap_gene_expression(adata, f"{disease}", "C5ar1", "C5ar2", gene_dict, save_path="Mm-Normal_umap_C5ar1vC5ar2.pdf")